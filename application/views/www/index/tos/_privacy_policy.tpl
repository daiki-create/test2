株式会社モンテカンポ（以下「当社」といいます。）は、当社の提供するサービス（以下「本サービス」といいます。）における、ユーザーについての個人情報を含む利用者情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。
...
<div class="my-3">
    ...
    <ul class="my-3 pl-0">
        <li class="mb-0">◦氏名</li>
        <li class="mb-0">◦メールアドレス</li>
        <li class="mb-0">◦生年月日</li>
        <li class="mb-0">◦クレジットカード情報</li>
        <li class="mb-0">◦写真</li>
        <li class="mb-0">◦その他当社が定める入力フォームにユーザーが入力する情報</li>
    </ul>
</div>
...
<div class="mb-3">
    ⑶ユーザーが本サービスを利用するにあたって、当社が収集する情報<br>
...
<ul>
    ...
    <li>
        <ul>
            ...
            <ul>
                <li>(対応する利用者情報の項目)</li>
                <li class="mb-0">◦端末情報</li>
                <li class="mb-0">◦ログ情報</li>
                <li class="mb-0">◦Cookie及び匿名ID</li>
                <li class="mb-0">◦位置情報</li>
            </ul>
            <li>⑶その他マーケティングに利用するため</li>
            <ul>
                <li class="mb-0">(対応する利用者情報の項目)</li>
                <li class="mb-0">◦氏名</li>
                <li class="mb-0">◦メールアドレス</li>
                <li class="mb-0">◦生年月日</li>
                <li class="mb-0">◦その他当社が定める入力フォームにユーザーが入力する情報</li>
...
<ul>
    <li>3-1　以下の利用者情報については、その収集が行われる前にユーザーの同意を得るものとします。</li>
    <li>
        <ul>
            <li>⑴　端末情報</li>
            <li>⑵　位置情報</li> 
...
{* -------------------------------------------------------------------------------------------------------------------*}
<h4>6.個人情報の訂正及び利用停止等</h4>

<ul>
    <li>
        6-1　当社は、ユーザーから、⑴個人情報が真実でないという理由によって個人情報保護法の定めに基づきその内容の訂正を求められた場合、及び⑵あらかじめ公表された利用目的の範囲を超えて取り扱われているという理由または偽りその他不正の手段により収集されたものであるという理由により、個人情報保護法の定めに基づきその利用の停止を求められた場合には、ユーザーご本人からのご請求であることを確認の上で遅滞なく必要な調査を行い、その結果に基づき、個人情報の内容の訂正または利用停止を行い、その旨をユーザーに通知します。なお、合理的な理由に基づいて訂正または利用停止を行わない旨の決定をしたときは、ユーザーに対しその旨を通知いたします。
    </li>
    <li>
...
<div class="mb-3">
    ...
    <br></br>
    住所：〒105-0003 <br>
    東京都港区西新橋2-13-6ミタニビル３階 <br>
    株式会社 モンテカンポ <br>
    E-mail：info@montecampo.co.jp <br>
</div>
...
<div class="mb-3">
    当社は、利用者情報の取扱いに関する運用状況を適宜見直し、継続的な改善に努めるものとし、必要に応じて、本ポリシーを変更することがあります。変更した場合には、WEBサイトに掲示する方法でユーザーに通知いたします。但し、法令上ユーザーの同意が必要となるような内容の変更の場合は、当社所定の方法でユーザーの同意を得るものとします。
</div>
